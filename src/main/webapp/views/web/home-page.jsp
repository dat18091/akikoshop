			...
			<div class="container">
				<div class="row">
					<div class="col-sm-12">
						<!-- LOGO START -->
						<div class="logo">
							<a href="index.html"><img src="<c:url value="/design/web/img/akiko-logo.png" />" alt="bstore logo" /></a>
						</div>
						<!-- LOGO END -->
						<!-- HEADER-RIGHT-CALLUS START -->
						<div class="header-right-callus">
							<h3>GỌI MIỄN PHÍ</h3>
							<span>(+84) 337-560-999</span>
						</div>
						...
						<div class="categorys-product-search">
							<form action="#" method="get" class="search-form-cat">
								<div class="search-product form-group">
									...
									<input type="text" class="form-control search-form" name="s" placeholder="Tìm sản phẩm, thương hiệu và tên shop ... " />
