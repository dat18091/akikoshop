...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Akiko Việt Nam | Danh Sách Loại Danh Mục</title>
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Danh Sách Loại DM</li>
						</ul><!-- /.breadcrumb -->
										...
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														<td>${category.getCategoryTypeName()}</td>
														<td>${category.getDescription()}</td>
														<td class="hidden-480">
															<span class="label label-sm label-info arrowed arrowed-righ">${category.getSeoURL()}</span>
														</td>
														<td class="hidden-480">
															<span class="label label-sm label-info arrowed arrowed-righ">${category.getSeoKeyword()}</span>
														</td>
														<td>${category.getCreatedDate()}</td>
														<td><span class="label label-sm label-warning">${category.getCreatedBy()}</span></td>
														<td>
															<div class="hidden-sm hidden-xs btn-group">
															<a href="details-category-type?categoryTypeId=${category.getCategoryTypeId()}" class="btn btn-xs btn-success" data-toggle="modal" data-target="#myModal"><i class="ace-icon fa fa-eye bigger-120"></i></a>
															<a href="update-category-type?categoryTypeId=${category.getCategoryTypeId()}" class="btn btn-xs btn-info"><i class="ace-icon fa fa-pencil bigger-120"></i></a>
															<a onclick="return confirm('Bạn có chắc chắn muốn xóa loại danh mục này?')" href="delete-category-type?categoryTypeId=${category.getCategoryTypeId()}" class="btn btn-xs btn-danger"><i class="ace-icon fa fa-trash-o bigger-120"></i></a>
															<a href="category-type-info?categoryTypeId=${category.getCategoryTypeId()}" class="btn btn-xs btn-warning"><i class="ace-icon fa fa-flag bigger-120"></i></a>
															</div>
														</td>
													</tr>
													</c:forEach>
