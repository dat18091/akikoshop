...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Akiko Việt Nam | Dashboard</title>
													...
													<table class="table table-bordered table-striped">
														...
														<tbody>
															<tr>
																...
																<td>
																	<small><s style="color: red">$29.99</s></small>
														...
														<div id="member-tab" class="tab-pane">
															<div class="clearfix">
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Bob Doe's avatar" src="<c:url value="/design/admin/images/avatars/user.jpg" />" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Joe Doe's avatar" src="<c:url value="/design/admin/images/avatars/avatar2.png" />" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Jim Doe's avatar" src="<c:url value="/design/admin/images/avatars/avatar.png" />" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Alex Doe's avatar" src="<c:url value="/design/admin/images/avatars/avatar5.png" />" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Bob Doe's avatar" src="<c:url value="/design/admin/images/avatars/avatar2.png" />" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Susan's avatar" src="<c:url value="/design/admin/images/avatars/avatar3.png" />" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Phil Doe's avatar" src="<c:url value="/design/admin/images/avatars/avatar4.png" />" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Alexa Doe's avatar" src="<c:url value="/design/admin/images/avatars/avatar1.png" />" />
																	</div>
														...
														<div id="comment-tab" class="tab-pane">
															<div class="comments">
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Bob Doe's Avatar" src="<c:url value="/design/admin/images/avatars/avatar.png" />" />
																	</div>
																...
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Jennifer's Avatar" src="<c:url value="/design/admin/images/avatars/avatar1.png" />" />
																	</div>
																...
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Joe's Avatar" src="<c:url value="/design/admin/images/avatars/avatar2.png" />" />
																	</div>
																...
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Rita's Avatar" src="<c:url value="/design/admin/images/avatars/avatar3.png" />" />
																	</div>
												...
												<div class="widget-main no-padding">
													<div class="dialogs">
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="Alexa's Avatar" src="<c:url value="/design/admin/images/avatars/avatar1.png" />" />
															</div>
														...
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="John's Avatar" src="<c:url value="/design/admin/images/avatars/avatar.png" />" />
															</div>
														...
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="Bob's Avatar" src="<c:url value="/design/admin/images/avatars/user.jpg" />" />
															</div>
														...
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="Jim's Avatar" src="<c:url value="/design/admin/images/avatars/avatar4.png" />" />
															</div>
...
<![endif]-->
		...
		<script src="<c:url value="/design/admin/js/jquery.easypiechart.min.js" />"></script>
		<script src="<c:url value="/design/admin/js/jquery.sparkline.index.min.js" />"></script>
		<script src="<c:url value="/design/admin/js/jquery.flot.min.js" />"></script>
		<script src="<c:url value="/design/admin/js/jquery.flot.pie.min.js" />"></script>
		<script src="<c:url value="/design/admin/js/jquery.flot.resize.min.js" />"></script>
